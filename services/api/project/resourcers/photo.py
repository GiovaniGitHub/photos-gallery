...
from project.repositories.serialializers import PhotoRequestSchema, PhotoResponseSchema
...
class PhotoResource(Resource):
    ...
    def post(self, album_id):
        ...
        create_photo(user_id=str(current_user.id), album_id=album_id, photo_data=None)
