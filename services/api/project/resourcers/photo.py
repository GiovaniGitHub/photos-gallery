...
from project.controllers.photo_controller import create_photo, like_picture
...
class PhotoResource(Resource):
    ...
    def get(self, album_id):
        try:
            ...
            photos = get_photos_by_album_and_owner(album_id=album_id, owner_id=current_user.id)
...
class PhotoLikeResource(Resource):
    @jwt_required()
    def post(self, album_id: str, photo_id: str):
        like_picture(album_id=album_id, photo_id=photo_id)
        return None, 201